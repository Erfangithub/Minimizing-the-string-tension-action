...
void fintz2sin(mpfr_t* I, mpfr_t c2, mpfr_t c1, mpfr_t c0, mpfr_t zero, int prec)
{
    ...
    else
    {
        ...
        mpfr_pow_ui(H,arg2,2,MPFR_RNDD);
        mpfr_cos(H,H,MPFR_RNDD);
        mpfr_div_ui(P,arg2,2,MPFR_RNDD);
        mpfr_sub(P,arg3,P,MPFR_RNDD);
        mpfr_mul(H,P,H,MPFR_RNDD);
        
        mpfr_pow_ui(P,arg3,2,MPFR_RNDD);
        mpfr_cos(P,P,MPFR_RNDD);
        mpfr_mul(P,P,arg3,MPFR_RNDD);
        mpfr_div_ui(P,P,2,MPFR_RNDD);
        
        mpfr_sub(H,H,P,MPFR_RNDD);
        
        mpfr_sub(P,C(arg2, Numf, prec)[0],C(arg3, Numf, prec)[0],MPFR_RNDD);
        ...
        mpfr_pow_ui(P,sa2,3,MPFR_RNDD);
        
        mpfr_div(H,H,P,MPFR_RNDD);
        
        mpfr_set(*I,H,MPFR_RNDD);
        ...
        mpfr_pow_ui(K,arg2,2,MPFR_RNDD);
        mpfr_sin(K,K,MPFR_RNDD);
        mpfr_div_ui(P,arg2,2,MPFR_RNDD);
        mpfr_sub(P,arg3,P,MPFR_RNDD);
        mpfr_mul(K,P,K,MPFR_RNDD);
